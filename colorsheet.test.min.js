...
function(){it("should return a string",function(){assert.equal(typeof colorsheet.getWcagLevels(7),"string")});it("should return aaa contrast ratio at a contrast ratio >= 7",function(){assert.equal(colorsheet.getWcagLevels(7),"wcag: 07.00 (AA)")})})});
